        ...
        imageList.map((item) => (
          <div key={item.id} style={{ background: item.background }}>
            <Space vertical align="start" spacing="medium" className={styles.space}>
              ...
              <Title heading={2} className={styles.black} data-testid="title">{textList[item.id][0]}</Title>
              <Space vertical align="start">
                <Paragraph className={styles.black} data-testid="paragraph1">{textList[item.id][1]}</Paragraph>
                <Paragraph className={styles.black} data-testid="paragraph2">{textList[item.id][2]}</Paragraph>
              </Space>
            </Space>
          </div>
        ))
