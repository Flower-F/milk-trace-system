      ...
      <div className={styles['flex-box']}>
        <div className={styles.left}>
          ...
          <div className={styles.cow}>
            <img src="/cow.png" alt="奶牛" loading="lazy" />
          </div>
        </div>
        <div className={styles.right}>
          <img src="/cow-2.png" alt="奶牛" loading="lazy" />
        </div>
      </div>

      <div className={styles['display-picture']}>
        <img src="/cow-3.png" alt="奶牛" loading="lazy" />
        <img src="/cow-4.png" alt="奶牛" className={styles['right-picture']} loading="lazy" />
      </div>
    </div>
  );
};
